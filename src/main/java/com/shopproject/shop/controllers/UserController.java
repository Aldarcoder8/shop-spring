...
import com.shopproject.shop.models.Role;
import com.shopproject.shop.models.User;
import com.shopproject.shop.repo.ItemRepository;
import com.shopproject.shop.repo.UserRepository;
...
public class UserController {
    ...
    public String reg(@RequestParam(name = "error", defaultValue = "", required = false) String error, Model model) {
        if(error.equals("username")) {
            model.addAttribute("error","Such login already exists");
        }
        return "reg";
    }
